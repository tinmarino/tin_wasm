/// Canvas utilities (just for playing around for now)
use std::cell::Cell;
use std::rc::Rc;
...
#[allow(dead_code)]
/// From: https://rustwasm.github.io/wasm-bindgen/examples/paint.html
pub fn canvas_paint() -> Result<(), JsValue> {
    let canvas = create_canvas("id_canvas_paint")?;
    let context = canvas
        .get_context("2d")?
        .unwrap()
